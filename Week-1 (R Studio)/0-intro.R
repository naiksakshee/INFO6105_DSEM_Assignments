...
##step-1: defined a 4x4 matrix serially numbered from 1-16
mm <- matrix(1:16,nrow=4,ncol=4)

mm

##step-2: selects the bottom left of matrix 'mm'
mm[3:4,1:2]


## Q: anything specific you'd like to know about R?

##answer: 1. I would love to learn to make interactive web apps in R
##        2. Connect to any database and interact with data through R
